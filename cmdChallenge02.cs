...
namespace RevitAIbootcamp
{
    ...
    public class cmdChallenge02 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            TaskDialog.Show("Select lines", "Select the drawn lines to convert to Revit elements.");
            ...
            //NOTE:the lines "currentLevel = GetLevelByName()" is a created method, it doesn't exist before...
            //... the code from "internal Level GetLevelByName..."(at the end of this code, way down) is selected, then right-clicked and "Quick Actions and Refactorings" is selected
            //then select on the left-hand-side "Extract method" and name it "GetLevelByName", hit return
            //it automatically creates the lines "GetLevel...return..." and the line "private static ..." (renamed to "internal static")
            //NOTE: the third argument of "GetLevelByName" is "currentLevel" but it's deleted as it is not needed
            ...
            //when first typing "GetWallTypeByName" or "GetDuctTypeByName" this is not recognized and throws an error
            //but by right-clicking in the line (i.e where it says "GetMEPSystemByName) and selecting "Quick Actions and Refactoring"...
            //... the expression "GetSomethingTypeByName" gets converted into a method
            //go to the end of the code where you find "private" statements for PipeType, DuctType, WallType, etc...
            //these private statements get added-in by Visual studio automatically

            // 5. loop hrough curve elements
        ...
        // this internal method gets re-used and accomodated in the private statements above, especially the foreach-loop
        // the lines "levelCollector.OfCategory..." and "levelCollector.WhereElement..." get replaced by the mroe generic "collector.OfClass()"
        internal Level GetLevelByName(Document doc, string levelName) //"Level currentLevel" is created as a third argument but deleted, not needed
        {
            FilteredElementCollector levelCollector = new FilteredElementCollector(doc);
            levelCollector.OfCategory(BuiltInCategory.OST_Levels);
            levelCollector.WhereElementIsElementType();
            ...
            return null; //because "Level currentLevel" is deleted "return" is set to "null"
        }
